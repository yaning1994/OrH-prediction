...
mkdir /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun
cd /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun
```
```sh
#created munged sumstats
cat /work/home/acd2j8na2s/Work/PRSprofile/5_allGWASandData/BMI/UKBB/BMI.gwas.QC.CAS | head
#SNP     CHR     BP      EA      OA      EAF     Beta    se      P       N

python /work/home/acd2j8na2s/Work/polyfun/polyfun/munge_polyfun_sumstats.py \
    --sumstats /work/home/acd2j8na2s/Work/PRSprofile/5_allGWASandData/BMI/UKBB/BMI.gwas.QC.CAS \
    --out /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/bolt.sumstats.munged.parquet
#ValueError: cannot both specify --n and have an N column in the sumstats file

#in python read 
#df = pd.read_parquet('/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/bolt.sumstats.munged.parquet')
...
--sumstats /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/bolt.sumstats.munged.parquet \
--out /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/snps_with_var.gz
...
mkdir /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step1
python /work/home/acd2j8na2s/Work/polyfun/polyfun/create_finemapper_jobs.py \
    --sumstats /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/snps_with_var.gz \
    --n 457824 \
    --method susie \
    --max-num-causal 5 \
    --out  /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step1/polyfun_output \
    --jobs-file /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/jobs.txt \
...
python /work/home/acd2j8na2s/Work/polyfun/polyfun/aggregate_finemapper_results.py \
    --out-prefix /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step1/polyfun_output \
    --sumstats /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/snps_with_var.gz \
    --out /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step1/polyfun_output.agg.txt.gz \
    --adjust-beta-freq \
    --allow-missing-jobs
...
mkdir /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2
gzip -d /work/home/acd2j8na2s/Work/polyfun/polyfun/polypred_example/bolt.betas.gz
```
用下边的文件试试
```py
import pandas as pd 
import numpy as np 
df = pd.read_csv('/work/home/acd2j8na2s/Work/PRSprofile/5_allGWASandData/BMI/UKBB/BMI.gwas.QC.CAS',sep='\t')
#SNP  CHR      BP EA OA       EAF      Beta        se     P       N
df['GENPOS']=0
df = df[['SNP','CHR','BP','GENPOS','EA','OA','Beta']]
df.columns=['SNP','CHR','BP','GENPOS','ALLELE1','ALLELE0','BETA']
df.to_csv('/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/uk.bolt.betas',sep='\t',index=False)
#df2 = pd.read_csv('/work/home/acd2j8na2s/Work/polyfun/polyfun/polypred_example/bolt.betas',sep='\t')
#df.dtypes
#df2.dtypes
df = pd.read_csv('/work/home/acd2j8na2s/Work/PRSprofile/5_allGWASandData/BMI/BBJ/BMI.gwas.QC.CAS',sep='\t')
#SNP  CHR      BP EA OA       EAF      Beta        se     P       N
df['GENPOS']=0
df = df[['SNP','CHR','BP','GENPOS','EA','OA','Beta']]
df.columns=['SNP','CHR','BP','GENPOS','ALLELE1','ALLELE0','BETA']
df.to_csv('/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/bbj.bolt.betas',sep='\t',index=False)



#10      rs9419461       124767  T       C       -6.533581e-07
df = pd.read_csv('/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/PRScs/UKBB/pst_eff_a1_b0.5_phiauto.txt',sep='\t',header=None)
df.columns=['CHR','SNP','BP','EA','OA','Beta']
df['GENPOS']=0
df = df[['SNP','CHR','BP','GENPOS','EA','OA','Beta']]
df.columns=['SNP','CHR','BP','GENPOS','ALLELE1','ALLELE0','BETA']
df.to_csv('/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/uk.PRScs.betas',sep='\t',index=False)

df = pd.read_csv('/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/PRScs/BBJ/pst_eff_a1_b0.5_phiauto.txt',sep='\t',header=None)
df.columns=['CHR','SNP','BP','EA','OA','Beta']
df['GENPOS']=0
df = df[['SNP','CHR','BP','GENPOS','EA','OA','Beta']]
df.columns=['SNP','CHR','BP','GENPOS','ALLELE1','ALLELE0','BETA']
df.to_csv('/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/bbj.PRScs.betas',sep='\t',index=False)
```
# 3. Linearly combining the effect sizes of PolyFun and the other method in small training set
```sh
cat /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/uk.bolt.betas | head 
#SNP     CHR     BP      GENPOS  ALLELE1 ALLELE0 BETA

mkdir /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3
```
...
db <- 'UKBB'
trait <- 'BMI'
restdir <- '/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3'
...
mkdir /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3/plink 
for i in {1..22}
do
$plinkpwd --bfile /work/home/acd2j8na2s/Work/PRSprofile/5_allGWASandData/BMI/plink/STS2030 \
--chr $i \
 --make-bed -out \
 /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3/plink/STS2030.$i
done
...
python /work/home/acd2j8na2s/Work/polyfun/polyfun/polypred.py \
    --combine-betas \
    --betas /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/uk.PRScs.betas,/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/bbj.PRScs.betas,/work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step1/polyfun_output.agg.txt.gz \
    --pheno /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3/y_tune.txt \
    --output-prefix /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3/polypredP \
    --plink-exe /work/home/acd2j8na2s/software/plink \
    /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3/plink/STS2030.*.bed 

#sbatch /work/home/acd2j8na2s/Work/PRSprofile/0_script/polyfunjobs.minbeta.slurm
#4525320
#[INFO]  Writing mixing weights to /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3/polypred.mixweights
#[INFO]  Loading betas file /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/uk.bolt.betas...
#[INFO]  done in 4.18 seconds
#[INFO]  Loading betas file /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step2/bbj.bolt.betas...
#[INFO]  done in 4.26 seconds
#[INFO]  Loading betas file /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step1/polyfun_output.agg.txt.gz...
#[INFO]  done in 12.72 seconds
#[INFO]  Saving weighted betas to /work/home/acd2j8na2s/Work/PRSprofile/7_single_ancestry_PRS/BMI/polyfun/step3/polypred.betas
```

# 4. Computing PRS in the target population using the combined SNP effect sizes
```sh
sbatch /work/home/acd2j8na2s/Work/PRSprofile/0_script/PRSinRforPolypred.slurm
```
